 ...
 * Purpose : Action to get suggestions
 */
import { Store } from "../Store";

/**
 *  This file is where, once the user adds an ingredient, we make the fetch request to our backend, get the response back and then
 *  call dispatch the changes we have to the reducer so that the state can be changed
 */
